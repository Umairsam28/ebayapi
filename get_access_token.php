  ...
  $codeAuth = base64_encode('ErgodeTr-FastMedi-PRD-6ed59bfca-98f3f70b:PRD-ed59bfcac2da-90e5-43ed-8f14-6c31');
    ...
    //    echo $this->refreshToken;
       // curl_setopt($ch, CURLHEADER_SEPARATE, true);
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS, "grant_type=refresh_token&refresh_token=v^1.1#i^1#I^3#p^3#f^0#r^1#t^Ul4xMF8xOkJCOTY4RTlENTNGNDZCQkExNTMwRUQyN0FEMzJDOTlFXzFfMSNFXjI2MA==&rscope=https://api.ebay.com/oauth/api_scope https://api.ebay.com/oauth/api_scope/sell.marketing.readonly https://api.ebay.com/oauth/api_scope/sell.marketing https://api.ebay.com/oauth/api_scope/sell.inventory.readonly https://api.ebay.com/oauth/api_scope/sell.inventory https://api.ebay.com/oauth/api_scope/sell.account.readonly https://api.ebay.com/oauth/api_scope/sell.account https://api.ebay.com/oauth/api_scope/sell.fulfillment.readonly https://api.ebay.com/oauth/api_scope/sell.fulfillment https://api.ebay.com/oauth/api_scope/sell.analytics.readonly");
